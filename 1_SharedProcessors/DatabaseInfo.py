...
class DatabaseInfo:
    ...
    def get_all_column_names():
        return ['TimeStamp', 'FrameNumber', 'LHEAD.PosX', 'LHEAD.PosY', 'LHEAD.PosZ', 'THEAD.PosX', 'THEAD.PosY',
                'THEAD.PosZ', 'RHEAD.PosX', 'RHEAD.PosY', 'RHEAD.PosZ', 'FHEAD.PosX', 'FHEAD.PosY', 'FHEAD.PosZ',
                ' C7.PosX', ' C7.PosY', ' C7.PosZ', 'T10.PosX', 'T10.PosY', 'T10.PosZ', 'SACR.PosX', 'SACR.PosY',
                'SACR.PosZ', 'NAVE.PosX', 'NAVE.PosY', 'NAVE.PosZ', 'XYPH.PosX', 'XYPH.PosY', 'XYPH.PosZ', 'STRN.PosX',
                'STRN.PosY', 'STRN.PosZ', 'BBAC.PosX', 'BBAC.PosY', 'BBAC.PosZ', 'LSHO.PosX', 'LSHO.PosY', 'LSHO.PosZ',
                'LDELT.PosX', 'LDELT.PosY', 'LDELT.PosZ', 'LLEE.PosX', 'LLEE.PosY', 'LLEE.PosZ', 'LMEE.PosX',
                'LMEE.PosY', 'LMEE.PosZ', 'LFRM.PosX', 'LFRM.PosY', 'LFRM.PosZ', 'LMW.PosX', 'LMW.PosY', 'LMW.PosZ',
                'LLW.PosX', 'LLW.PosY', 'LLW.PosZ', 'LFIN.PosX', 'LFIN.PosY', 'LFIN.PosZ', 'RSHO.PosX', 'RSHO.PosY',
                'RSHO.PosZ', 'RDELT.PosX', 'RDELT.PosY', 'RDELT.PosZ', 'RLEE.PosX', 'RLEE.PosY', 'RLEE.PosZ',
                'RMEE.PosX', 'RMEE.PosY', 'RMEE.PosZ', 'RFRM.PosX', 'RFRM.PosY', 'RFRM.PosZ', 'RMW.PosX', 'RMW.PosY',
                'RMW.PosZ', 'RLW.PosX', 'RLW.PosY', 'RLW.PosZ', 'RFIN.PosX', 'RFIN.PosY', 'RFIN.PosZ', 'LASIS.PosX',
                'LASIS.PosY', 'LASIS.PosZ', 'RASIS.PosX', 'RASIS.PosY', 'RASIS.PosZ', 'LPSIS.PosX', 'LPSIS.PosY',
                'LPSIS.PosZ', 'RPSIS.PosX', 'RPSIS.PosY', 'RPSIS.PosZ', 'LGTRO.PosX', 'LGTRO.PosY', 'LGTRO.PosZ',
                'FLTHI.PosX', 'FLTHI.PosY', 'FLTHI.PosZ', 'LLEK.PosX', 'LLEK.PosY', 'LLEK.PosZ', 'LATI.PosX',
                'LATI.PosY', 'LATI.PosZ', 'LLM.PosX', 'LLM.PosY', 'LLM.PosZ', 'LHEE.PosX', 'LHEE.PosY', 'LHEE.PosZ',
                'LTOE.PosX', 'LTOE.PosY', 'LTOE.PosZ', 'LMT5.PosX', 'LMT5.PosY', 'LMT5.PosZ', 'RGTRO.PosX',
                'RGTRO.PosY', 'RGTRO.PosZ', 'FRTHI.PosX', 'FRTHI.PosY', 'FRTHI.PosZ', 'RLEK.PosX', 'RLEK.PosY',
                'RLEK.PosZ', 'RATI.PosX', 'RATI.PosY', 'RATI.PosZ', 'RLM.PosX', 'RLM.PosY', 'RLM.PosZ', 'RHEE.PosX',
                'RHEE.PosY', 'RHEE.PosZ', 'RTOE.PosX', 'RTOE.PosY', 'RTOE.PosZ', 'RMT5.PosX', 'RMT5.PosY', 'RMT5.PosZ',
                'FP1.CopX', 'FP1.CopY', 'FP1.CopZ', 'FP1.ForX', 'FP1.ForY', 'FP1.ForZ', 'FP1.MomX', 'FP1.MomY',
                'FP1.MomZ', 'FP2.CopX', 'FP2.CopY', 'FP2.CopZ', 'FP2.ForX', 'FP2.ForY', 'FP2.ForZ', 'FP2.MomX',
                'FP2.MomY', 'FP2.MomZ', 'F1Y1', 'F1Y2', 'F1Y3', 'F1X1', 'F1X2', 'F1Z1', 'F2Y1', 'F2Y2', 'F2Y3', 'F2X1',
                'F2X2', 'F2Z1', 'Sensor13_EMG', 'Sensor13_AccX', 'Sensor13_AccY', 'Sensor13_AccZ', 'Sensor14_EMG',
                'Sensor14_AccX', 'Sensor14_AccY', 'Sensor14_AccZ', 'Sensor15_EMG', 'Sensor15_AccX', 'Sensor15_AccY',
                'Sensor15_AccZ', 'Cortex Time', 'D-Flow Time', 'LeftBeltSpeed', 'ReferenceFY_FP1', 'RightBeltSpeed',
                'Time']
