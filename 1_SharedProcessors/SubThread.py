...
def get_combined_result_df(input_names, output_names, result_column, base_model, i_sub):
    ...
    segment_combo_class = SegmentCombos(combo_value, thigh_diameter, shank_diameter)
...
def save_evaluator(evaluator_dict, model, input_names, output_names, folder_name):
