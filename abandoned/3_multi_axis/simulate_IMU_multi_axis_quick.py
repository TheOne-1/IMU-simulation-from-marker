...
for i_sub in range(SUB_NUM):
    ...
    offset_axis_8 = OneAxisTranslation('r_thigh', 'theta', range(-30, 31, 5), shank_diameter)
    multi_offset_axis.add_offset_axis(offset_axis_8)
    offset_axis_9 = OneAxisTranslation('l_shank', 'z', range(-100, 101, 20))
...
EvaluationUni.save_result(total_result_df, model, input_names, output_names, 'result_multi_axis')
