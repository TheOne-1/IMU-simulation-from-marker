...
class DatabaseInfo:
    def __init__(self):
        # 49, 50, 51 have different marker names
        self.__trial_num = np.array([[16, 19, 25, 32, 40, 46, 55, 61, 67, 76, 49, 73],
                                     [17, 20, 26, 31, 41, 47, 56, 62, 68, 77, 50, 74],
                                     [18, 21, 27, 33, 42, 48, 57, 63, 69, 78, 51, 75]])

        self.__column_names = ['TimeStamp', 'FrameNumber', 'LHEAD.PosX', 'LHEAD.PosY', 'LHEAD.PosZ',
    ...
    def get_trial_num(self, sub=0, speed=0):
        return self.__trial_num[speed, sub]
